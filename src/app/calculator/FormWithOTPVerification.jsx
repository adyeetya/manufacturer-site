...
const FormWithOTPVerification = ({ handleDownloadPDF }) => {
  ...
  const handleSendOTP = async () => {
    try {
      ...
      await axios.post('https://api.designindianwardrobe.com/api/send-otp', {
  ...
  const handleVerifyNumber = async () => {
    try {
      ...
      await axios.post(
        'https://api.designindianwardrobe.com/api/verify-number',
  ...
  const handleVerifyOTP = async () => {
    try {
      ...
      await axios.post('https://api.designindianwardrobe.com/api/verify-otp', {
                  ...
                  <div className="flex justify-center">
                    {[...Array(4)].map((_, index) => (
                      <input
                        ...
                        className="w-12 h-12 text-center border border-gray-300 rounded mr-2"
                        style={{
                          width: '3rem',
                        }}
