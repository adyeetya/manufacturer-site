  ...
  return (
    <>
      <head>
        ...
        <link
          rel="canonical"
          href={`https://www.modularkitchenmanufacturer.com/contact-us`}
        />
        <meta name="googlebot" content="index, follow" />
        <meta name="Yahoobot" content="index, follow" />
        <meta name="MSNbot" content="Index, Follow" />
        ...
        <meta
          property="og:url"
          content={`https://www.modularkitchenmanufacturer.com/contact-us`}
        />
        <meta
          property="og:title"
      ...
      <div className=" my-12 mx-auto sm:mx-16">
        {/* breadcrumb */}
        <div className="px-4  ">
        ...
        <div className="container mx-auto p-4 my-4">
          ...
          {/* Contact Card */}
          <div className="mt-8 bg-white rounded p-4 shadow-md w-full sm:w-1/4 mx-auto">
